...
def main():
    ...
    # #     print()
    #     #break
    # model = PrecomputionLight(train_dataset, '../../dataset_bulk_train_precomputed', k=1, overwrite=True)
    # model.make()
    # print()
    ...
    # model = ContextNetTry2()
    # # model = torch.load('./checkpoints/contextnet_45.pth')
    ...
    model = torch.load('./models/contextnet_280_focal_loss_aug.pth')
